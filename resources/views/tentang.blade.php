...
<head>
    ...
    <!-- Material -->
    <link rel="stylesheet" href="css/tentang-style.css" type="text/css">
    ...
    <div class="container-fluid px-0 bg-body-tertiary">
        ...
        <header class="shadow fixed-top d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 bg-body-secondary">
            ...
            <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
                ...
                <li><a class="nav-link px-4 text-secondary fs-5 fw-semibold font-monospace" href="/tentang">Tentang</a></li>
        ...
        <div class="mt-5 font-monospace">
            <div class="p-5 text-center bg-body-tertiary">
                <div class="container py-5" style="background-image: url('images/banner/b3.jpg'); background-size: 65%;">
        ...
        <!-- Tentang Bagian-1 -->
        <section class="tentang-section mb-5">
            <div class="container-fluid px-4 py-2 font-monospace">
                <div class="row mb-4">
                    <div class="col-lg-4 offset-lg-1">
                        <div class="tentang-left">
                            <div class="section-title">
                                <h2 class="fs-1 fw-bold">Baggora.</h2>
                            </div>
                            <p> "Baggora adalah platform thrifting daring yang menawarkan pilihan pakaian bekas berkualitas dengan harga terjangkau. 
                                Baggora berkomitmen untuk mendukung UMKM lokal dan mengurangi dampak lingkungan dari pakaian bekas impor ilegal. 
                                Di Baggora, Anda dapat menemukan berbagai gaya fashion dari vintage hingga modern, dari casual hingga formal, dari lokal 
                                hingga internasional. Baggora juga memberikan layanan pengiriman cepat, pembayaran aman, dan garansi kepuasan. Baggora adalah 
                                tempat yang tepat untuk Anda yang mencintai fashion dan peduli lingkungan. Bergabunglah dengan komunitas Baggora sekarang dan 
                                nikmati pengalaman belanja thrifting yang menyenangkan dan bermanfaat. 🛍️"
                            </p>
                        </div>
                    </div>

                    <div class="col-lg-5 offset-lg-1">
                        <div class="tentang-pic">
                            <img src="images/banner/b6.jpg">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container px-4 py-2 font-monospace">
            <h2 class="pb-2 border-2 border-black border-bottom text-center fw-bold">Our Team!</h2>
            <div class="row row-cols-1 row-cols-lg-3 align-items-stretch g-4 py-5">
                <div class="col-lg-6">
                    <div class="row">
                        <div class="col-lg-12 mb-5">
                            <div class="card card-cover overflow-hidden text-bg-dark rounded-4 shadow-lg" style="background-image: url('images/ourTeam/irpan.jpg'); background-size: 100%; cursor: pointer;" onclick="window.location.href='https://www.instagram.com/zigizaraaa';">
                                <div class="d-flex flex-column p-5 pb-3 text-shadow-1 text-center" style="height: 500px;">
                                    <h3 class="fs-3 display-6 fw-bold bg-dark">Irfan Zharauri Nanda Sudiyanto</h3>
                                </div>
                            </div>
                        </div>

                        <div class="col-lg-12">
                            <div class="card card-cover overflow-hidden text-bg-dark rounded-4 shadow-lg" style="background-image: url('images/ourTeam/hapis.jpg'); background-size: 100%; cursor: pointer;" onclick="window.location.href='https://twitter.com/saranghaeshopi/status/1724709356858745181/photo/4';">
                                <div class="d-flex flex-column p-5 pb-3 text-shadow-1 text-center" style="height: 500px;">
                                    <h3 class="fs-3 display-6 fw-bold bg-dark">Hafiz Yazid</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6">
                    <div class="row">
                        <div class="col-lg-12 mb-5">
                            <div class="card card-cover overflow-hidden text-bg-dark rounded-4 shadow-lg" style="background-image: url('images/ourTeam/rafi.jpg'); background-size: 100%; cursor: pointer;" onclick="window.location.href='https://twitter.com/saranghaeshopi/status/1724710405258506608/photo/3';">
                                <div class="d-flex flex-column p-5 pb-3 text-shadow-1 text-center" style="height: 500px;">
                                    <h3 class="fs-3 display-6 fw-bold bg-dark">Muhammad Rafi</h3>
                                </div>
                            </div>
                        </div>

                        <div class="col-lg-12">
                            <div class="card card-cover overflow-hidden text-bg-dark rounded-4 shadow-lg" style="background-image: url('images/card-kiri-bawah.jpg'); cursor: pointer;">
                                <div class="d-flex flex-column p-5 pb-3 text-shadow-1 text-center" style="height: 500px;">
                                    <h3 class="fs-3 display-6 fw-bold bg-dark">Fransiskus Ishak</h3>
                                </div>
                            </div>
                        </div>
                    </div>
